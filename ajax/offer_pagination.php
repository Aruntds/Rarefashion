...
$db_handle = new DBController();
	...
	if($token!=''){
  		$sql_query_token = sqlQUERY_LABEL("SELECT `prdt_id` FROM `js_offers_items` where offers_id = '$token' and deleted = '0' and status = '2'") or die("#STATUS-SELECT: Getting Status: ".sqlERROR_LABEL());
