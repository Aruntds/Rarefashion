                          ...
                          <div class="clearfix"></div>
							...
							?>
								...
								<div class="product-size" id="product-size">
									...
									?>
									<a href="javascript:;" class="active" Onclick="getSIZE('<?php echo $variant_ID; ?>','<?php echo $variant_msp_price+$tot_tax_value; ?>','<?php echo $variant_mrp_price; ?>','<?php echo $variant_size_count; ?>');" title="<?php echo general_currency_symbol; ?><?php echo number_format($variant_msp_price+$tot_tax_value,2);?>" id="variant_size_display"><?php echo $variant_name; ?></a>
									<?php } else { ?>
									<a href="javascript:;" Onclick="getSIZE('<?php echo $variant_ID; ?>','<?php echo $variant_msp_price+$tot_tax_value; ?>','<?php echo $variant_mrp_price; ?>','<?php echo $variant_size_count; ?>');" title="<?php echo general_currency_symbol; ?><?php echo number_format($variant_msp_price+$tot_tax_value,2);?>" ><?php echo $variant_name; ?></a>
									<?php } ?>
									<?php
									}
									?>
